...
class Product(models.Model):
    ...
    price = models.DecimalField(max_digits=10, decimal_places=2, blank=False, null=False)  # price of product
    image_url = models.URLField()  # a url field for product images
    description = models.TextField()
    stock_quantity = models.PositiveIntegerField(default=0, blank=False, null=False)  # default value to 0
